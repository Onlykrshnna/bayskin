...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Bayskin | Best Laser Treatment and Skin Clinic in Lajpat Nagar, New Delhi" },
      { name: "description", content: "Bayskin is the premier laser treatment and skin care clinic in Lajpat Nagar, New Delhi. Offering top-tier treatments like Carbon Facials, Laser Hair Reduction, and more." },
      { property: "og:title", content: "Bayskin | Best Laser Treatment and Skin Clinic" },
      { property: "og:description", content: "Experience professional skin and laser treatments at Bayskin in Lajpat Nagar." },
    ],
  }),
  component: Index,
});
